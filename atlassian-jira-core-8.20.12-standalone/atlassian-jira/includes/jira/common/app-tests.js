AJS.test.require(["jira.webresources:jira-global"], function () {
    ...
    module("shouldInitTooltips", {
        setup: function setup() {
            ...
            this.tipsyRevalidateStub = this.sandbox.stub($.fn.tipsy, 'revalidate');
                ...
                setTimeout(function tooltipAttached() {
                    if (hasTooltip) {
                        ...
                        setTimeout(function tooltipDetached() {
                            ...
                            sinon.assert.calledOnce(this.tipsyRevalidateStub, "tipsy.revalidate should be called at element detach");
                            done();
                        }.bind(this), 10);
                    } else {
