    ...
    function initTooltips() {
        ...
        var destroyTooltip = function destroyTooltip(element) {
            if (element[TOOLTIP_INITIALIZED]) {
                ...
                // unfortunately, hiding tooltips with `tooltip('destroy')` doesn't always work (likely a bug in tipsy)
                // fortunately, tipsy offers `revalidate` method which will remove all 'stale' tooltips
                $.fn.tipsy && $.fn.tipsy.revalidate();
            }
        };
