        ...
        <ui:param name="'content'">
            ...
            <ww:if test="permission == true">
                ...
                <ww:if test="/multiSelect == true">
                    <form class="selectorform" name="selectorform" onsubmit="addItemsToInputField('input[data-group-select]')">
                        <table class="aui aui-table-rowhover">
                            <thead>
                                <tr>
                                    <th width="1%"><input type="checkbox" name="all" onClick="setCheckboxes()" aria-label="<ww:text name="'generic.picker.selectall'"/>"></th>
                            ...
                            <ww:iterator value="currentPage" status="'status'">
                                <tr data-row-for="<ww:property value="name"/>" title="<ww:text name="'picker.click.to.select'"><ww:param name="'value0'"><ww:property value="name"/></ww:param></ww:text>">
                                    ...
                                    <td onclick="toggleCheckBox(event, 'group_<ww:property value="@status/index"/>')"><label for="group_<ww:property value="@status/index"/>"><ww:property value="name"/></label></td>
                                </tr>
                            </ww:iterator>
                            </tbody>
                        </table>
                ...
                <ww:else>
                    <form class="selectorform" name="selectorform" onsubmit="selectSingleGroup(event)">
                        <table class="aui aui-table-rowhover">
                            <thead>
                                <tr>
                                    <th width="1%"></th>
                            ...
                            <tbody>
                            <ww:iterator value="currentPage" status="'status'">
                                <tr data-row-for="<ww:property value="name"/>" title="<ww:text name="'picker.click.to.select'"><ww:param name="'value0'"><ww:property value="name"/></ww:param></ww:text>" onclick="setRadio('group_<ww:property value="@status/index"/>')">
