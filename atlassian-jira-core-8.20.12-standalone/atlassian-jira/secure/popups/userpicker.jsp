        ...
        <ui:param name="'content'">
            ...
            <ww:if test="permission == true">
                ...
                <ww:if test="/multiSelect == true">
                    <form class="selectorform" name="selectorform" onsubmit="addItemsToInputField('input[data-user-select]')">
                        ...
                        <table class="aui aui-table-rowhover">
                            <thead>
                                <tr>
                                    <th width="1%"><span class="assistive"><ww:text name="'userpicker.table.selection.row.multi'" /></span><input type="checkbox" name="all" onClick="setCheckboxes()" aria-label="<ww:text name="'generic.picker.selectall'"/>"></th>
                            ...
                            <ww:iterator value="currentPage" status="'status'">
                                <tr data-row-for="<ww:property value="name"/>" id="username_row_<ww:property value="@status/index"/>" title="<ww:text name="'picker.click.to.select'"><ww:param name="'value0'"><ww:property value="displayName"/></ww:param></ww:text>">
                                    ...
                                    <td data-cell-type="name" class="user-name" onclick="toggleCheckBox(event, 'user_<ww:property value="@status/index"/>')"><label for="user_<ww:property value="@status/index"/>"><ww:property value="name"/></label></td>
                ...
                <ww:else>
                    <form class="selectorform" name="selectorform" onsubmit="selectSingleUser(event)">
                        <div class="aui-group count-pagination">
                            <h2 id="search-results" class="results-count aui-item" role="status">
                                <ww:text name="'userpicker.displayingusers'" value0="niceStart" value1="niceEnd" value2="users/size" />
                            </h2>
